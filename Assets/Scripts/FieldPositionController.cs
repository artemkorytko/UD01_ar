...
{ 
    ...
    private void Update()
    {
        if(_arRaycastManager == null || IsActive == false)
            return;

        Vector2 screenCenterPosition = new Vector2(Screen.currentResolution.width*0.5f,Screen.currentResolution.height*0.5f);
